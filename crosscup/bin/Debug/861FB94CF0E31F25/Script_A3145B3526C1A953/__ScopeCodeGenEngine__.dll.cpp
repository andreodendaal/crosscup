...
// Explicit instantiations for templated functions that are defined in managed code
    ...
    {
    public:
        FString m___STAGE20237ead2f9d20c84dba8cd70c4e69573362;
        FString m___BIB2023f18ed006c08243049ca84dd005aae21e;
        FString m___FIRST20NAME6eae963464d34142ab04b26514eeb505;
        FString m___LAST20NAME30181b2959c94ad29bc3875a86b87109;
        FString m_TEAM;
        FString m_CITY;
        FString m_STATE;
        FString m_AGE;
        FString m_CAT;
        FString m_LICENSE;
        FString m___CXR20Points2a709102151c493bb34a97e918b9dc81;
        FString m___CCC20Pointsc509874a2be74a1d81719fb5d8f0c856;
        FString m___Category20Entered46650e8c1bbd4b528c31483ca84fe173;
        FString m___CCC20Points20Most20Recent20Date20Placing67e74e3a7c4148a8a6f4e5d65d9db6d7;
        FString m___CCC20Points20Most20Recent20Date383bc9550e6049b085acfcf44c9a99a1;
        FString m___Time20Entered27bade28b1a34eb3b0e8c09ca4f565da;
        Extract_0_Data0();
    ...
    {
        os << "\t" << std::string{ u8"STAGE #" } << ":\t" << row.m___STAGE20237ead2f9d20c84dba8cd70c4e69573362 << endl;
        os << "\t" << std::string{ u8"BIB #" } << ":\t" << row.m___BIB2023f18ed006c08243049ca84dd005aae21e << endl;
        os << "\t" << std::string{ u8"FIRST NAME" } << ":\t" << row.m___FIRST20NAME6eae963464d34142ab04b26514eeb505 << endl;
        os << "\t" << std::string{ u8"LAST NAME" } << ":\t" << row.m___LAST20NAME30181b2959c94ad29bc3875a86b87109 << endl;
        ...
        os << "\t" << std::string{ u8"CXR Points" } << ":\t" << row.m___CXR20Points2a709102151c493bb34a97e918b9dc81 << endl;
        os << "\t" << std::string{ u8"CCC Points" } << ":\t" << row.m___CCC20Pointsc509874a2be74a1d81719fb5d8f0c856 << endl;
        os << "\t" << std::string{ u8"Category Entered" } << ":\t" << row.m___Category20Entered46650e8c1bbd4b528c31483ca84fe173 << endl;
        os << "\t" << std::string{ u8"CCC Points Most Recent Date Placing" } << ":\t" << row.m___CCC20Points20Most20Recent20Date20Placing67e74e3a7c4148a8a6f4e5d65d9db6d7 << endl;
        os << "\t" << std::string{ u8"CCC Points Most Recent Date" } << ":\t" << row.m___CCC20Points20Most20Recent20Date383bc9550e6049b085acfcf44c9a99a1 << endl;
        os << "\t" << std::string{ u8"Time Entered" } << ":\t" << row.m___Time20Entered27bade28b1a34eb3b0e8c09ca4f565da << endl;
        return os;
    }
#endif // defined(SCOPE_DEBUG)
    ...
    public:
        ...
        FString m_Time;
        FString m_Gap;
        FString m___Lap20142764ca2cdad469199a5d9aa6eac9e55;
        FString m___Lap2023890760c7bf74f0ab70c9bc5ce64971b;
        FString m___Lap203a6070df4e140421882e106d2407ea80a;
        FString m___Lap2048b545d29711e40d582259c17c6755a3c;
        FString m___Lap2053c81aea30beb43faab3218dadc34ed7d;
        FString m___Lap206cf0c525740b548618bad07e46a39e764;
        FString m___Lap2071fcb0ecb3a13451fa05a961735241dc1;
        FString m___Lap208333e2fc45dd94b01b0eadf3acc7bd36b;
        SV2_Extract_out0();
    ...
    INLINE ostream & operator<<(ostream & os, SV2_Extract_out0 & row)
    {
        ...
        os << "\t" << std::string{ u8"Lap 1" } << ":\t" << row.m___Lap20142764ca2cdad469199a5d9aa6eac9e55 << endl;
        os << "\t" << std::string{ u8"Lap 2" } << ":\t" << row.m___Lap2023890760c7bf74f0ab70c9bc5ce64971b << endl;
        os << "\t" << std::string{ u8"Lap 3" } << ":\t" << row.m___Lap203a6070df4e140421882e106d2407ea80a << endl;
        os << "\t" << std::string{ u8"Lap 4" } << ":\t" << row.m___Lap2048b545d29711e40d582259c17c6755a3c << endl;
        os << "\t" << std::string{ u8"Lap 5" } << ":\t" << row.m___Lap2053c81aea30beb43faab3218dadc34ed7d << endl;
        os << "\t" << std::string{ u8"Lap 6" } << ":\t" << row.m___Lap206cf0c525740b548618bad07e46a39e764 << endl;
        os << "\t" << std::string{ u8"Lap 7" } << ":\t" << row.m___Lap2071fcb0ecb3a13451fa05a961735241dc1 << endl;
        os << "\t" << std::string{ u8"Lap 8" } << ":\t" << row.m___Lap208333e2fc45dd94b01b0eadf3acc7bd36b << endl;
        return os;
    }
#endif // defined(SCOPE_DEBUG)
...
// project, and then turn off /doc.
        ...
        static bool Deserialize(BinaryInputStream * input, SV2_Extract_out0 & row)
        {
            try
            {
                ...
                if (b==0)
                {
                    ...
                    input->Read(row.m___Lap20142764ca2cdad469199a5d9aa6eac9e55);
                    input->Read(row.m___Lap2023890760c7bf74f0ab70c9bc5ce64971b);
                    input->Read(row.m___Lap203a6070df4e140421882e106d2407ea80a);
                    input->Read(row.m___Lap2048b545d29711e40d582259c17c6755a3c);
                    input->Read(row.m___Lap2053c81aea30beb43faab3218dadc34ed7d);
                    input->Read(row.m___Lap206cf0c525740b548618bad07e46a39e764);
                    input->Read(row.m___Lap2071fcb0ecb3a13451fa05a961735241dc1);
                    input->Read(row.m___Lap208333e2fc45dd94b01b0eadf3acc7bd36b);
                }
                else
                {
                    ...
                    {
                        row.m___Lap20142764ca2cdad469199a5d9aa6eac9e55.SetNull();
                    }
                    ...
                    {
                        row.m___Lap2023890760c7bf74f0ab70c9bc5ce64971b.SetNull();
                    }
                    ...
                    {
                        row.m___Lap203a6070df4e140421882e106d2407ea80a.SetNull();
                    }
                    ...
                    {
                        row.m___Lap2048b545d29711e40d582259c17c6755a3c.SetNull();
                    }
                    ...
                    {
                        row.m___Lap2053c81aea30beb43faab3218dadc34ed7d.SetNull();
                    }
                    ...
                    {
                        row.m___Lap206cf0c525740b548618bad07e46a39e764.SetNull();
                    }
                    ...
                    {
                        row.m___Lap2071fcb0ecb3a13451fa05a961735241dc1.SetNull();
                    }
                    ...
                    {
                        row.m___Lap208333e2fc45dd94b01b0eadf3acc7bd36b.SetNull();
                    }
                }
            }
            catch (ScopeStreamException &) 
    ...
    public:
        ...
        __declspec(noinline) static void Serialize(BinaryOutputStream * output, SV2_Extract_out0 & row)
        {
            ...
            if (row.m___Lap20142764ca2cdad469199a5d9aa6eac9e55.IsNull())
            {
                hasNull = true;
                ___masking___[1] |= 1;
            }
            if (row.m___Lap2023890760c7bf74f0ab70c9bc5ce64971b.IsNull())
            {
                hasNull = true;
                ___masking___[1] |= 2;
            }
            if (row.m___Lap203a6070df4e140421882e106d2407ea80a.IsNull())
            {
                hasNull = true;
                ___masking___[1] |= 4;
            }
            if (row.m___Lap2048b545d29711e40d582259c17c6755a3c.IsNull())
            {
                hasNull = true;
                ___masking___[1] |= 8;
            }
            if (row.m___Lap2053c81aea30beb43faab3218dadc34ed7d.IsNull())
            {
                hasNull = true;
                ___masking___[1] |= 16;
            }
            if (row.m___Lap206cf0c525740b548618bad07e46a39e764.IsNull())
            {
                hasNull = true;
                ___masking___[1] |= 32;
            }
            if (row.m___Lap2071fcb0ecb3a13451fa05a961735241dc1.IsNull())
            {
                hasNull = true;
                ___masking___[1] |= 64;
            }
            if (row.m___Lap208333e2fc45dd94b01b0eadf3acc7bd36b.IsNull())
            {
                hasNull = true;
                ___masking___[1] |= 128;
            }
            ...
            if (!row.m___Lap20142764ca2cdad469199a5d9aa6eac9e55.IsNull())
            {
                output->Write(row.m___Lap20142764ca2cdad469199a5d9aa6eac9e55);
            }
            if (!row.m___Lap2023890760c7bf74f0ab70c9bc5ce64971b.IsNull())
            {
                output->Write(row.m___Lap2023890760c7bf74f0ab70c9bc5ce64971b);
            }
            if (!row.m___Lap203a6070df4e140421882e106d2407ea80a.IsNull())
            {
                output->Write(row.m___Lap203a6070df4e140421882e106d2407ea80a);
            }
            if (!row.m___Lap2048b545d29711e40d582259c17c6755a3c.IsNull())
            {
                output->Write(row.m___Lap2048b545d29711e40d582259c17c6755a3c);
            }
            if (!row.m___Lap2053c81aea30beb43faab3218dadc34ed7d.IsNull())
            {
                output->Write(row.m___Lap2053c81aea30beb43faab3218dadc34ed7d);
            }
            if (!row.m___Lap206cf0c525740b548618bad07e46a39e764.IsNull())
            {
                output->Write(row.m___Lap206cf0c525740b548618bad07e46a39e764);
            }
            if (!row.m___Lap2071fcb0ecb3a13451fa05a961735241dc1.IsNull())
            {
                output->Write(row.m___Lap2071fcb0ecb3a13451fa05a961735241dc1);
            }
            if (!row.m___Lap208333e2fc45dd94b01b0eadf3acc7bd36b.IsNull())
            {
                output->Write(row.m___Lap208333e2fc45dd94b01b0eadf3acc7bd36b);
            }
            SIZE_T rowSize =  output->GetOutputer().GetCurrentPosition() - rowStart;
            auto rowLimit = ScopeEngine::Configuration::GetGlobal().GetMaxOnDiskRowSize();
            if (rowSize > rowLimit)
...
// project, and then turn off /doc.
    ...
    INLINE SV2_Extract_out0::SV2_Extract_out0(const SV2_Extract_out0 & c, IncrementalAllocator * alloc) :
            ...
            m_Gap(c.m_Gap, alloc),
            m___Lap20142764ca2cdad469199a5d9aa6eac9e55(c.m___Lap20142764ca2cdad469199a5d9aa6eac9e55, alloc),
            m___Lap2023890760c7bf74f0ab70c9bc5ce64971b(c.m___Lap2023890760c7bf74f0ab70c9bc5ce64971b, alloc),
            m___Lap203a6070df4e140421882e106d2407ea80a(c.m___Lap203a6070df4e140421882e106d2407ea80a, alloc),
            m___Lap2048b545d29711e40d582259c17c6755a3c(c.m___Lap2048b545d29711e40d582259c17c6755a3c, alloc),
            m___Lap2053c81aea30beb43faab3218dadc34ed7d(c.m___Lap2053c81aea30beb43faab3218dadc34ed7d, alloc),
            m___Lap206cf0c525740b548618bad07e46a39e764(c.m___Lap206cf0c525740b548618bad07e46a39e764, alloc),
            m___Lap2071fcb0ecb3a13451fa05a961735241dc1(c.m___Lap2071fcb0ecb3a13451fa05a961735241dc1, alloc),
            m___Lap208333e2fc45dd94b01b0eadf3acc7bd36b(c.m___Lap208333e2fc45dd94b01b0eadf3acc7bd36b, alloc)
    {
    }
        ...
        static bool Deserialize(TextInputStream<TextInputStreamTraitsConst<',', '\0', '\0', false, true, UTF8, true, true, false, 1, CharFormat_uint16>, CosmosInput> * input, Extract_0_Data0 & row)
        {
            for(;;)
            {
                try
                {
                    ...
                    input->Read(row.m___STAGE20237ead2f9d20c84dba8cd70c4e69573362);
                    input->Read(row.m___BIB2023f18ed006c08243049ca84dd005aae21e);
                    input->Read(row.m___FIRST20NAME6eae963464d34142ab04b26514eeb505);
                    input->Read(row.m___LAST20NAME30181b2959c94ad29bc3875a86b87109);
                    ...
                    input->Read(row.m___CXR20Points2a709102151c493bb34a97e918b9dc81);
                    input->Read(row.m___CCC20Pointsc509874a2be74a1d81719fb5d8f0c856);
                    input->Read(row.m___Category20Entered46650e8c1bbd4b528c31483ca84fe173);
                    input->Read(row.m___CCC20Points20Most20Recent20Date20Placing67e74e3a7c4148a8a6f4e5d65d9db6d7);
                    input->Read(row.m___CCC20Points20Most20Recent20Date383bc9550e6049b085acfcf44c9a99a1);
                    input->Read(row.m___Time20Entered27bade28b1a34eb3b0e8c09ca4f565da);
...
// project, and then turn off /doc.
    ...
    public:
        ...
        static bool FilterTransformRow(Extract_0_Data0 & input, SV1_Extract_out0 & output, IncrementalAllocator * alloc)
        {
            ...
            try
            {
                output.m_stagebib = input.m___BIB2023f18ed006c08243049ca84dd005aae21e;
                exceptionIndex++;
                output.m_usaclicence = input.m_LICENSE;
                exceptionIndex++;
                output.m_racestaging = input.m___STAGE20237ead2f9d20c84dba8cd70c4e69573362;
                exceptionIndex++;
...
// project, and then turn off /doc.
    ...
    public:
        ...
        static void CopyRow(SV2_Extract_out0 * left, SV1_Extract_out0 * right, HashJoin_3_Data0 * out)
        {
                ...
                (*out).m___Lap20142764ca2cdad469199a5d9aa6eac9e55 = (*left).m___Lap20142764ca2cdad469199a5d9aa6eac9e55;
                (*out).m___Lap2023890760c7bf74f0ab70c9bc5ce64971b = (*left).m___Lap2023890760c7bf74f0ab70c9bc5ce64971b;
                (*out).m___Lap203a6070df4e140421882e106d2407ea80a = (*left).m___Lap203a6070df4e140421882e106d2407ea80a;
                (*out).m___Lap2048b545d29711e40d582259c17c6755a3c = (*left).m___Lap2048b545d29711e40d582259c17c6755a3c;
                (*out).m___Lap2053c81aea30beb43faab3218dadc34ed7d = (*left).m___Lap2053c81aea30beb43faab3218dadc34ed7d;
                (*out).m___Lap206cf0c525740b548618bad07e46a39e764 = (*left).m___Lap206cf0c525740b548618bad07e46a39e764;
                (*out).m___Lap2071fcb0ecb3a13451fa05a961735241dc1 = (*left).m___Lap2071fcb0ecb3a13451fa05a961735241dc1;
                (*out).m___Lap208333e2fc45dd94b01b0eadf3acc7bd36b = (*left).m___Lap208333e2fc45dd94b01b0eadf3acc7bd36b;
        ...
        static void NullifyLeftSide(HashJoin_3_Data0 * out)
        {
            ...
            (*out).m_Time.SetNull();
            (*out).m_Gap.SetNull();
            (*out).m___Lap20142764ca2cdad469199a5d9aa6eac9e55.SetNull();
            (*out).m___Lap2023890760c7bf74f0ab70c9bc5ce64971b.SetNull();
            (*out).m___Lap203a6070df4e140421882e106d2407ea80a.SetNull();
            (*out).m___Lap2048b545d29711e40d582259c17c6755a3c.SetNull();
            (*out).m___Lap2053c81aea30beb43faab3218dadc34ed7d.SetNull();
            (*out).m___Lap206cf0c525740b548618bad07e46a39e764.SetNull();
            (*out).m___Lap2071fcb0ecb3a13451fa05a961735241dc1.SetNull();
            (*out).m___Lap208333e2fc45dd94b01b0eadf3acc7bd36b.SetNull();
        }
    };
#endif // defined(COMPILE_NATIVE)
// All of the templates will throw a CS1591 warning because we 
...
// project, and then turn off /doc.
    ...
    public:
        ...
        static void CopyBoth(const SV2_Extract_out0 & probe, const ValueSchema * build, HashJoin_3_Data0 & output)
        {
            ...
            output.m___Lap20142764ca2cdad469199a5d9aa6eac9e55 = probe.m___Lap20142764ca2cdad469199a5d9aa6eac9e55;
            output.m___Lap2023890760c7bf74f0ab70c9bc5ce64971b = probe.m___Lap2023890760c7bf74f0ab70c9bc5ce64971b;
            output.m___Lap203a6070df4e140421882e106d2407ea80a = probe.m___Lap203a6070df4e140421882e106d2407ea80a;
            output.m___Lap2048b545d29711e40d582259c17c6755a3c = probe.m___Lap2048b545d29711e40d582259c17c6755a3c;
            output.m___Lap2053c81aea30beb43faab3218dadc34ed7d = probe.m___Lap2053c81aea30beb43faab3218dadc34ed7d;
            output.m___Lap206cf0c525740b548618bad07e46a39e764 = probe.m___Lap206cf0c525740b548618bad07e46a39e764;
            output.m___Lap2071fcb0ecb3a13451fa05a961735241dc1 = probe.m___Lap2071fcb0ecb3a13451fa05a961735241dc1;
            output.m___Lap208333e2fc45dd94b01b0eadf3acc7bd36b = probe.m___Lap208333e2fc45dd94b01b0eadf3acc7bd36b;
    ...
    public:
        ...
        static bool FilterTransformRow(HashJoin_3_Data0 & input, Process_4_Data0 & output, IncrementalAllocator * alloc)
        {
            ...
            try
            {
                ...
                exceptionIndex++;
                output.m_lap1 = input.m___Lap20142764ca2cdad469199a5d9aa6eac9e55;
                exceptionIndex++;
                output.m_lap2 = input.m___Lap2023890760c7bf74f0ab70c9bc5ce64971b;
                exceptionIndex++;
                output.m_lap3 = input.m___Lap203a6070df4e140421882e106d2407ea80a;
                exceptionIndex++;
                output.m_lap4 = input.m___Lap2048b545d29711e40d582259c17c6755a3c;
                exceptionIndex++;
                output.m_lap5 = input.m___Lap2053c81aea30beb43faab3218dadc34ed7d;
                exceptionIndex++;
                output.m_lap6 = input.m___Lap206cf0c525740b548618bad07e46a39e764;
                exceptionIndex++;
                output.m_lap7 = input.m___Lap2071fcb0ecb3a13451fa05a961735241dc1;
                exceptionIndex++;
                output.m_lap8 = input.m___Lap208333e2fc45dd94b01b0eadf3acc7bd36b;
                exceptionIndex++;
